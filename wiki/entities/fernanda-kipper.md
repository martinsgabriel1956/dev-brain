...
Desenvolvedora e criadora de conteúdo técnico (canal no YouTube), com material voltado a fundamentos de desenvolvimento web e cloud. Seu site pessoal `fernandakipper.com` está hospedado na [[wiki/entities/vercel]]; domínios comprados na [[wiki/entities/godaddy]] (mais antigos) e na [[wiki/entities/hostinger]] (mais recentes).
