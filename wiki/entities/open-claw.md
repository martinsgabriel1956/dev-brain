...
Agente open source (MIT), citado em [[wiki/sources/hermes-agent-open-claw-learning-loop]] como referência de mercado que o [[wiki/entities/hermes-agent]] busca igualar/superar — mesmo modelo de licenciamento, mesma proposta de rodar na máquina do usuário ou em VPS própria, e mesma ideia de messaging gateway multi-plataforma (Telegram, Discord, Slack, WhatsApp).
