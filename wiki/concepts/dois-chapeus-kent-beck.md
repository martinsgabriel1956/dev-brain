...
## Reforço: primeira dica de Fowler para refatorar com segurança

[[wiki/sources/refatoracao-pragmatic-programmer-martin-fowler-2a-edicao]] atribui a Fowler a mesma regra com outras palavras, como a primeira de três dicas para refatorar sem causar dano: nunca misturar adicionar funcionalidade com refatorar no mesmo momento — ligado explicitamente ao ciclo RED-GREEN-REFACTOR do [[wiki/concepts/tdd]] (primeiro faz funcionar, depois refatora).
