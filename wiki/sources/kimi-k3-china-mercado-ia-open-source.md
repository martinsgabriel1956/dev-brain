...
- "Fable" é citado no vídeo como um modelo/produto ao lado de GPT-5.6 e Sonnet — não fica claro na fala se é o mesmo Fable 5 (modelo Anthropic mencionado em outras fontes desta wiki) ou outro produto; tratado aqui como o mesmo, sem confirmação cruzada nesta fonte. **Atualização:** [[wiki/sources/mitos-fable-5-bloqueio-governo-eua-cyberseguranca]] também cita "Fable 5" e "GPT 5.6" lado a lado como modelos bloqueados pelo governo dos EUA por risco de cybersegurança — reforça que são o mesmo produto citado aqui, embora nenhuma das duas fontes seja uma confirmação oficial e independente da nomenclatura.
