...
> Tradução para português do verbete de glossário **"test run"**, do site xUnit Patterns.
> Fonte: http://xunitpatterns.com/test%20run.html
...
Um **test** (teste) ou **test suite** (suíte de testes) pode ser executado várias vezes, cada uma com um **test result** (resultado de teste) diferente.
